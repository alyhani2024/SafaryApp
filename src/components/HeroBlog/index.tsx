    ...
    <>
      ...
      >
        <Image
          ...
          height={2000}
          alt="img"
          className="imgHome absolute top-0 "
        />

        <div className="container ">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="bg-transparent-background mx-auto max-w-[450px]  text-center">
                ...
                <p className="mb-12 text-base !leading-relaxed text-white sm:text-lg md:text-xl">
                  ...
                  industry by connecting tourists with local Blogs in Egypt.
                  This innovative platform will provide tourists with easy
                  access to experienced Blogs , Choose Your blog and Join in .
                </p>
