...
export const metadata: Metadata = {
  title: "Success Page | Free Next.js Template for Startup and SaaS",
  description: "This is Success Page for Startup Next.js Template",
  // other metadata
};

const Tourguidesuccses = () => {
  return (
    <>
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  This is a success message indicating that your action was
                  successful.
                </p>
                <Link
                  href="/TourGuide"
                  className="px-8 py-3 text-base font-bold text-white duration-300 rounded-md bg-orange-500 shadow-signUp hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
...
export default Tourguidesuccses;
