...
const CarouselPerHour: React.FC<CarouselProps> = ({ tourGuides }) => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4 mt-4 ml-4">Tour Guides Per Hour</h2>
              ...
              <div className="h-full bg-white p-4 rounded-lg flex flex-col justify-between dark:bg-gray-700">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-700">{`$${tourGuide.pricePerHour.toFixed(2)} per hour`}</p>
                  </div>
                  <button
...
export default CarouselPerHour;
