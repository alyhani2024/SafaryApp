  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href={`/TourGuide/succses`} className="bg-orange-500 hover:bg-orange-400 text-white font-bold py-4 px-9 rounded-full text-lg whitespace-nowrap">
          Join In
        </Link>
      </div>
      <div>
...
export default GuideSingleBlogDetails;
